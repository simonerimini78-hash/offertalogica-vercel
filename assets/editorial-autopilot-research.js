  ...
  function cardMarkup() {
    return `
      <div class="ol-autopilot-card-heading">
        <div><h3>4. Ricerca, opportunità e piano del ciclo</h3><p>Flusso unico: idea o segnale → scelta → bozza → post collegati → controllo del ciclo. Nessuna azione di questa area pubblica automaticamente.</p></div>
      </div>
