(() => {
  ...
  function buildShell(){
    ...
    details.innerHTML=`
      <summary class="ol-collapsible-summary"><span><strong>Autopilota editoriale</strong><small>Stato, calendario, ricerca e controllo del ciclo</small></span><span class="ol-collapsible-action" aria-hidden="true">Apri</span></summary>
