export const PDF_CANDIDATE_CONTRACT_VERSION = "1.0.0";
...
const FIELDS = {
  fornitore: { group: "document", roles: ["identifier"], critical: true },
  ...
  prezzo_luce_eur_kwh: { group: "economic", unit: "EUR/kWh", roles: ["actual_customer_value", "offer_value", "sales_component"], critical: true },
  prezzo_gas_eur_smc: { group: "economic", unit: "EUR/Smc", roles: ["actual_customer_value", "offer_value", "sales_component"], critical: true },
  ...
  intestatario: { group: "identifier", roles: ["identifier"], critical: false },
  ...
  indirizzo_fornitura: { group: "identifier", roles: ["identifier"], critical: false },
  indirizzo_fornitura_luce: { group: "identifier", roles: ["identifier"], critical: false },
  indirizzo_fornitura_gas: { group: "identifier", roles: ["identifier"], critical: false },
...
export function aiPdfToCandidates(aiResult = {}, sourceVersion = "unknown") {
  ...
  return (Array.isArray(aiResult?.candidates) ? aiResult.candidates : []).map((candidate, index) => createPdfCandidate({
    ...candidate,
