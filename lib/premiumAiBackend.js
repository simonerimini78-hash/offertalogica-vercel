...
export async function loadPremiumBillContract({ config, bill, fetchImpl = fetch } = {}) {
  const params = {
    select: "id,user_id,utility_id,provider_name,pricing_type,electricity_price_eur_kwh,gas_price_eur_smc,electricity_fixed_fee_eur_year,gas_fixed_fee_eur_year,is_current,verification_status",
...
export function classifyPremiumAutomaticAnalysis(normalized = {}, { contract = null } = {}) {
