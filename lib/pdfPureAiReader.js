...
export const PDF_PURE_AI_READER_VERSION = "pure-ai-native-pdf-v2.0.4-premium-contract-dates";
...
const REQUEST_PROFILE = "ia_libera_compact_form_v3_3";
...
const USER_PROMPT = `Compila il modulo libero con importo totale, periodo, date, consumi, prezzo finale se esplicito, fasce, componenti, formula, quota fissa e, quando esplicitamente indicate, decorrenza e scadenza delle condizioni economiche. Mantieni la struttura tariffaria originale senza produrre spiegazioni.`;
