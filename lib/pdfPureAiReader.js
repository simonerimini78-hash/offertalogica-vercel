...
export const PDF_PURE_AI_READER_VERSION = "pure-ai-native-pdf-v1.0.9";
...
const ESSENTIAL_QUESTION_IDS = Object.freeze([
  ...
  "potenza_disponibile_kw", "consumo_luce_kwh", "consumo_luce_f1_kwh", "consumo_luce_f2_kwh",
  "consumo_luce_f3_kwh", "consumo_luce_f23_kwh", "consumo_gas_smc",
  "prezzo_luce_eur_kwh", "prezzo_luce_f0_eur_kwh", "prezzo_luce_f1_eur_kwh",
  "prezzo_luce_f2_eur_kwh", "prezzo_luce_f3_eur_kwh", "prezzo_luce_f23_eur_kwh",
  "prezzo_gas_eur_smc",
  ...
  "spread_luce_eur_kwh", "spread_gas_eur_smc", "moltiplicatore_indice_luce",
  "moltiplicatore_indice_gas", "struttura_prezzo_luce",
...
- Non usare consumi fatturati, del periodo, del mese, letture, stime o proiezioni come consumo annuo.
- Le singole fasce F1/F2/F3/F23 sono ammesse esclusivamente nelle domande dedicate e solo quando appartengono alla stessa riga/tabella di Consumo annuo o ultimi 12 mesi.

PREZZI E COSTI
- Per prezzo luce/gas usa soltanto una condizione commerciale contrattuale in EUR/kWh o EUR/Smc.
- Per la luce separa sempre F0, F1, F2, F3 e F23 nelle rispettive domande. Ogni risposta numerica deve contenere un solo prezzo in value_number.
- Se una scheda contiene sia opzione monoraria sia opzione a fasce, usa F0 come prezzo monorario generale e conserva separatamente F1/F2/F3.
...
- Per offerte variabili separa indice, eventuale moltiplicatore, spread, formula e periodicità. Non ricavare lo spread per sottrazione e non calcolare il prezzo finale.
...
- Riporta, quando presenti: venditore, nome esatto offerta, codice offerta, commodity, destinatari, tipo prezzo, prezzo commerciale, prezzi F0/F1/F2/F3/F23, quota fissa, indice, spread, formula, periodicità e validità.
- Per nome offerta, tipo prezzo, prezzo e quota fissa, includi nelle evidence anche l'intestazione vicina che dimostra il contesto, per esempio SCHEDA SINTETICA, CONDIZIONI ECONOMICHE o CORRISPETTIVI DEFINITI DAL VENDITORE.
...
- Quando sono presenti condizioni correnti e rinnovo dal mese 13/25/37, ogni risposta economica deve provenire esclusivamente dal periodo corrente. Nelle evidence includi la dicitura temporale che lo dimostra.
- Se la scheda sintetica riepiloga un Costo per consumi o Corrispettivo per il consumo definito dal venditore, quel totale commerciale ha priorità sulle singole componenti che lo compongono.
...
export function normalizePureAiOutput(parsed, {
  ...
  normalized.ai = {
    ...
    verification_protocol: "targeted_questions_compact_v4_full_pricing_matrix",
  };
