...
export const PDF_PURE_AI_READER_VERSION = "pure-ai-native-pdf-v2.0.9-gas-units-pcs";
...
const REQUEST_PROFILE = "ia_libera_compact_form_v3_5";
...
function mergeEssentialRecoveryOutput(primaryParsed, recoveryParsed, missing) {
  ...
  for (const recoverySupply of recovery.supplies || []) {
    ...
    for (const row of recoveryRows) {
      ...
      if (!requestedDirectly && !periodFallbackForAnnual && !gasCoefficientFallback) continue;
