...
export const PDF_PURE_AI_READER_VERSION = "pure-ai-native-pdf-v2.0.3-premium-auto-screening";
...
const REQUEST_PROFILE = "ia_libera_compact_form_v3_2";
...
Nel campo alerts segnala soltanto elementi espliciti nel PDF che meritano un approfondimento umano: conguagli o ricalcoli, variazioni di prezzo dichiarate, quote inattese, sconti dichiarati ma non applicati, penali, possibili doppi addebiti, condizioni economiche in scadenza o altri elementi chiaramente motivati. Non inventare anomalie e non usare alerts per semplici dati mancanti. Ogni alert deve indicare pagina ed evidenza sintetica.
...
const USER_PROMPT = `Compila il modulo libero con importo totale, periodo, date, consumi, prezzo finale se esplicito, fasce, componenti, formula, quota fissa e soli alert realmente motivati dal documento. Mantieni la struttura tariffaria originale senza produrre spiegazioni.`;
