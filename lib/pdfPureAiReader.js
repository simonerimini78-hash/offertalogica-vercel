...
export const PDF_PURE_AI_READER_VERSION = "pure-ai-native-pdf-v1.0.18";
...
function fixedFeeCandidate({
  ...
  const valid = numeric !== null && normalizedPeriod !== "none";
  return {
    value: valid ? numeric : null,
    value_text: valid ? (compact(valueText, 120) || String(numeric)) : null,
    unit: valid ? (compact(unit, 60) || null) : null,
