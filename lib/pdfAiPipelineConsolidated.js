...
export const PDF_AI_FALLBACK_PIPELINE_VERSION = "v106.8.8.8-consolidated-two-pass-1";
...
export function shouldAttemptPdfAiFallback({ normalized = {}, filename = "", deadlineAt = null, env = process.env } = {}) {
  if (!["fallback", "shadow"].includes(String(env.PDF_AI_MODE || "off").trim().toLowerCase())) {
