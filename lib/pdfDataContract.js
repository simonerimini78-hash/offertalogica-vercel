export const PDF_DATA_CONTRACT_VERSION = "1.2.1";
export const PDF_AUTOFILL_POLICY_VERSION = "1.2.1";
...
const UNIT_BY_FIELD = Object.freeze({
  ...
  quota_fissa_confrontabile_luce_eur_mese: "EUR/mese",
  ...
  quota_fissa_confrontabile_gas_eur_mese: "EUR/mese",
...
const COMMODITY_BY_FIELD = Object.freeze({
  ...
  quota_fissa_confrontabile_luce_eur_mese: "luce",
  ...
  quota_fissa_confrontabile_gas_eur_mese: "gas",
  pdr: "gas",
...
const COMPARISON_TARGETS = Object.freeze({
  ...
  quota_fissa_confrontabile_luce_eur_mese: ["in-luce-fisso-att"],
  ...
  quota_fissa_confrontabile_gas_eur_mese: ["in-gas-fisso-att"],
...
function supplyObject(input, commodity) {
  ...
  return {
    ...
    comparable_fixed_fee_monthly: isLuce ? input.quota_fissa_confrontabile_luce_eur_mese ?? null : input.quota_fissa_confrontabile_gas_eur_mese ?? null,
