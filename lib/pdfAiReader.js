...
export const PDF_AI_ADAPTER_VERSION = "2.5.2-runtime-budget";
...
function boundedTimeout(value) {
  const parsed = Number(value || 32_000);
  return Math.max(8_000, Math.min(40_000, Number.isFinite(parsed) ? parsed : 32_000));
}
