...
export const PDF_AI_ADAPTER_VERSION = "step8-clean-reader-v4-focused-critical-output";
...
- Return at most 8 economic rows and only when they can plausibly represent the current offer's electricity sales price, index/spread formula or fixed sales charge. Keep quantity, total amount and printed unit rate separate.
...
- Return at most 8 economic rows and only when they can plausibly represent the current offer's gas sales price, index/spread formula or fixed sales charge. Keep quantity, total amount and printed unit rate separate.
