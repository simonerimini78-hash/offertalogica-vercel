# OFFERTALOGICA PREMIUM — ARCHITETTURA SUPABASE V0.1
...
## 6. Cose volutamente non attivate

Lo schema v0.1 non attiva ancora:

- prezzi dell'abbonamento;
- provider di pagamento;
- obbligo di abbonamento attivo nelle policy di caricamento;
- analisi automatica;
- dashboard staff;
- notifiche reali;
...
2. Eseguire `supabase/premium-schema-v0.1.sql` nel SQL Editor.
3. Eseguire `supabase/premium-schema-v0.1-verify.sql`.
