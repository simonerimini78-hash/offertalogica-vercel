const CACHE="offertalogica-app-v1";
const CORE=["/app.html","/manifest.webmanifest","/assets/logo-offertalogica-header.png","/assets/logo-offertalogica-icon.png","/assets/app-icon-192.png","/assets/app-icon-512.png"];
