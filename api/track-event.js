...
function sanitizePayload(payload = {}) {
  ...
  return {
    ...
    trafficCampaignId: text(input.trafficCampaignId, 40),
    trafficAdGroupId: text(input.trafficAdGroupId, 40),
    trafficCreativeId: text(input.trafficCreativeId, 40),
    trafficMatchType: text(input.trafficMatchType, 20).toLowerCase(),
    trafficDevice: text(input.trafficDevice, 20).toLowerCase(),
    trafficNetwork: text(input.trafficNetwork, 20).toLowerCase(),
    ...
    pdfUploadSource: text(input.pdfUploadSource, 80).toLowerCase(),
    pdfUploadOfferId: text(input.pdfUploadOfferId, 90),
    pdfUploadOfferName: text(input.pdfUploadOfferName, 160),
    pdfUploadProvider: text(input.pdfUploadProvider, 100),
    ...
    inputSource: text(input.inputSource, 40).toLowerCase(),
    photoReadable: booleanOrNull(input.photoReadable),
    comparisonAutoStarted: booleanOrNull(input.comparisonAutoStarted),
