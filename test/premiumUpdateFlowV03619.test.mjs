...
test("il service worker v0.36.26 è limitato alla sola app", async () => {
...
test("etichette applicative allineate alla v0.36.26", async () => {
  ...
  assert.match(bills,/app_version:\s*"0\.36\.26"/);
});
