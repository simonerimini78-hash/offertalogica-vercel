...
test("il service worker v0.36.27 è limitato alla sola app", async () => {
...
test("etichette applicative allineate alla v0.36.27", async () => {
  ...
  assert.match(bills,/app_version:\s*"0\.36\.27"/);
});
