...
test("il service worker v0.36.25 è limitato alla sola app", async () => {
...
test("etichette applicative allineate alla v0.36.25", async () => {
  ...
  assert.match(app,/APP v0\.36\.25/);
  assert.match(app,/APP Premium v0\.36\.25/);
  assert.match(staff,/v0\.36\.25/);
  assert.match(staffPremium,/v0\.36\.25/);
  assert.match(bills,/app_version:\s*"0\.36\.25"/);
});
