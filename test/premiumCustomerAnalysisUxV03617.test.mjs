...
test("app, staff e cache sono allineati alla v0.36.17", () => {
  assert.match(app, /APP Premium v0\.36\.17/);
  assert.match(premiumBills, /app_version: "0\.36\.17"/);
  assert.match(staffHtml, /Area staff unica v0\.36\.17/);
  assert.match(staffHtml, /controllo costi · v0\.36\.17/);
