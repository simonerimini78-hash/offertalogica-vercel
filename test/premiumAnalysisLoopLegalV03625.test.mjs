...
test("v0.36.27 non rilancia automaticamente in loop una bolletta pending dopo un errore", () => {
...
test("v0.36.27 mantiene i comandi stabili e distingue analisi in corso da analisi interrotta", () => {
