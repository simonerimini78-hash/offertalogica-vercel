...
test("v0.36.25 non rilancia automaticamente in loop una bolletta pending dopo un errore", () => {
...
test("v0.36.25 mantiene i comandi stabili e distingue analisi in corso da analisi interrotta", () => {
