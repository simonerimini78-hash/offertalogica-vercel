...
test("v0.36.24 usa un fondo argento neutro e mantiene verdi solo gli elementi di marca", async () => {
...
test("v0.36.24 separa l'aggiornamento automatico app da quello manuale staff", async () => {
  ...
  assert.equal(JSON.parse(manifest).version, "0.36.24");
});
