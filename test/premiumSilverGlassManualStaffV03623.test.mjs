...
test("v0.36.25 usa un fondo argento neutro e mantiene verdi solo gli elementi di marca", async () => {
...
test("v0.36.25 separa l'aggiornamento automatico app da quello manuale staff", async () => {
