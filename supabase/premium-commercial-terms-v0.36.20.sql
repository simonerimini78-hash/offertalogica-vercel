-- OFFERTALOGICA PREMIUM v0.36.20
...
with check (
  ...
  and (
    (consent_type = 'terms' and version = 'premium-terms-v0.36.20-2026-08-06')
...
begin
  ...
  new.proof := jsonb_strip_nulls(jsonb_build_object(
    ...
    'terms_version', 'premium-terms-v0.36.20-2026-08-06',
  ...
  select
    exists (
      ...
      where consent_record.user_id = (select auth.uid())
        ...
        and consent_record.version = 'premium-terms-v0.36.20-2026-08-06'
...
begin
  ...
  values
    ('terms', 'premium-terms-v0.36.20-2026-08-06', true, 'premium_app', v_proof),
...
begin
  ...
  if v_acceptance
     and coalesce(new.raw_user_meta_data ->> 'premium_terms_version', '') = 'premium-terms-v0.36.20-2026-08-06'
    ...
    values
      (new.id, 'terms', 'premium-terms-v0.36.20-2026-08-06', true, 'premium_signup', v_proof),
...
comment on function public.premium_has_current_acceptances() is
  'Verifica i Termini commerciali v0.36.20 e le accettazioni privacy/cloud correnti.';
comment on function public.premium_accept_current_terms(jsonb) is
  'Registra i Termini commerciali Premium v0.36.20 e le accettazioni privacy/cloud correnti.';
